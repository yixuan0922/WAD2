          ...
          <div class="row">
              <div class="col-lg-8" style="position: relative;">
                <div style="position: relative;">
                  ...
                  <img style="position: absolute; left: 440px; top: -60px; width: 17%;" src="@/assets/focusTrackerHeader.png">
                </div>
                <!-- Task Board -->
              ...
              <div class="col-lg-4">
                <div id="focusTrackerHeader" class="row" style="position: absolute; z-index: 1; position: relative">
                    ...
                    <div class="row d-flex align-items-center justify-content-start">
                        ...
                        <!-- <input id="taskName" type="text" placeholder="What would you like to focus on?" v-model="taskName"> -->
                    </div>
                ...
                <div class="row" id="timerDiv" style="margin-top: 50px;">
                    ...
                    <p id="durationLabel" style="margin-top: 10px; display: none;">
                      Duration set: <span v-if="hoursSet != 0">{{ hoursSet }} hr</span> 
                      {{ minsSet }} min
                    </p>
                    <div id="focusBtns" style="display: none; justify-content: center; align-items: center; margin-top: 10px;">
                        <button class="btn btn-primary" style="margin-inline: 4px; display:inline" @click="startTimer" v-if="!isRunning && !continueCheck">Start</button>
                        ...
                        <button class="btn btn-danger" style="margin-inline: 4px;" @click="resetTimer">Reset Timer</button>
                        <button class="btn btn-dark" style="margin-inline: 4px;" @click="defaultTimer">End session</button>
                    </div>
                </div>
...
export default {
  ...
  methods: {
    categoryClick(){
          ...
          if (categories.getElementsByTagName('option')[0].innerText == 'Category'){
              categories.removeChild(categories.getElementsByTagName('option')[0]);
          }
      },
    clickReadyBtn(){
        if (this.taskName == "" || this.taskName == "Select a task" || this.category == "Category" || (this.minsSet == 0 && this.hoursSet == 0)){
