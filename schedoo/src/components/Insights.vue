    ...
    <div>
      <div class="container-fluid col-lg-12 px-5 scrollable-container">
        <div class="col-lg-12" style="margin-top: 20px;">
            ...
            <div class="row">
                <div class="line-chart-container col-lg-5 shadow-3" style="margin-right: 30px; margin-bottom: 20px; height: 430px; background-color: #FFFFFF; border-radius: 15px;">
                    <div id="line-chart" style="height: 400px; width: 400px;"></div>
                </div>
                <div class="col-lg-6 piechart-container shadow-3" style="background-color: #FFFFFF; border-radius: 15px; height: 430px">
